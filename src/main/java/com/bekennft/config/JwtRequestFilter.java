...
//		Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiSnVhcmEgQ29kaW5nIn0.nFgKqog3l5cnZ4gB7V8FG9IriHrt67hq-JhClqnfkrU
		...
		if (requestTokenHeader != null && requestTokenHeader.startsWith("Bearer ")) {
			...
			try {
				...
				System.out.println("Gabisa dapet jwt tokennya");
			} catch(ExpiredJwtException e) {
				System.out.println("Jwt token lu expired, tolong generate lagi");
			}
		} else {
			logger.warn("jwt nya ga dimulai dari kata bearer");
		}
